...
namespace ThaiMinhTruc.GUI
{
    public partial class FrmDMNhanVien : Form
    {
        ...
        //    // Thay đổi câu truy vấn SQL để chèn dữ liệu mới vào đầu danh sách
        //    sql = "INSERT INTO tblNhanVien(MaNhanVien,TenNhanVien,GioiTinh, DiaChi,DienThoai, NgaySinh) " +
        //          "VALUES (N'" + txtMaNhanVien.Text.Trim() + "',N'" + txtTenNhanVien.Text.Trim() + "',N'" + gt + "',N'" +
        //          txtDiaChi.Text.Trim() + "','" + mtbDienThoai.Text + "','" + Functions.ConvertDateTime(dtpNgaySinh.Text) + "')";

        //    Functions.RunSQL(sql);
        //    LoadDataGridView(); // Tải lại danh sách để hiển thị dữ liệu mới lên đầu danh sách
        //    ResetValues();
        //    btnXoa.Enabled = true;
        //    btnThem.Enabled = true;
        //    btnSua.Enabled = true;
