...
namespace ThaiMinhTruc.GUI
{
    ...
    {
        private const string V = "Hóa đơn bán hàng";
        private const string V1 = "HÓA ĐƠN BÁN HÀNG";
        DataTable tblCTHDB;
        private iTextSharp.text.Chunk titleFont;
        private iTextSharp.text.Font contentFont;
        private IEnumerable<HoaDon> danhSachHoaDon;

        public object XLBorderStyleValues { get; private set; }
        ...
        //    Functions.FillCombo("SELECT MaNhanVien, TenNhanVien FROM tblNhanVien", cboMaNhanVien, "TenNhanVien", "TenKhach");
        ...
        private void btnInHoaDon_Click(object sender, EventArgs e)
        {
            ...
            //exRange.Style.Borders.TopBorder = XLBorderStyleValues;
            exRange.Range["A1:Z300"].Font.Name = "Times new roman"; //Font chữ
            //exRange.Range["A1:G20"].Borders.Value = "All Borders"; //Font borders
            exRange.Range["A1:B3"].Font.Size = 10;
            exRange.Range["A1:B3"].Font.Bold = true;
            exRange.Range["A1:B3"].Font.ColorIndex = 7; //Màu chữ
            exRange.Range["A1:A1"].ColumnWidth = 7;
            exRange.Range["B1:B1"].ColumnWidth = 15;
            exRange.Range["A1:B1"].MergeCells = true;
            exRange.Range["A1:B1"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A1:B1"].Value = "Kho Hàng";
            exRange.Range["A2:B2"].MergeCells = true;
            exRange.Range["A2:B2"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A2:B2"].Value = "Pleiku-Gia Lai";
            exRange.Range["A3:B3"].MergeCells = true;
            exRange.Range["A3:B3"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A3:B3"].Value = "Điện thoại: (086)38526419";
            exRange.Range["C2:E2"].Font.Size = 16;
            exRange.Range["C2:E2"].Font.Bold = true;
            exRange.Range["C2:E2"].Font.ColorIndex = 1; //Màu đỏ
            ...
            exRange.Range["A1:C1"].Value = "Pleiku, ngày " + d.Day + " tháng " + d.Month + " năm " + d.Year;
        ...
        private void btnPdf_Click(object sender, EventArgs e)
        {
            ...
            {
                // Tạo một tài liệu PDF và kết nối nó với file đã chọn
                PdfWriter writer = PdfWriter.GetInstance(doc, new FileStream(saveFileDialog.FileName, FileMode.Create));
                doc.Open();



                // Thêm thông tin hóa đơn từ các TextBox và ComboBox
                string thongTinHoaDon = "Mã hóa đơn: " + txtMaHDBan.Text + "\n" +
                                         "Ngày bán: " + dtpNgayBan.Value.ToShortDateString() + "\n" +
                                         "Nhân viên: " + txtTenNhanVien.Text + "\n" +
                                         "Khách hàng: " + txtTenKhach.Text + "\n" +
                                         "Địa chỉ: " + txtDiaChi.Text + "\n" +
                                         "Điện thoại: " + mtbDienThoai.Text + "\n" +
                                         "Tổng tiền: " + txtTongTien.Text;
                Paragraph infoParagraph = new Paragraph();
                infoParagraph.Alignment = Element.ALIGN_LEFT;

                infoParagraph.Add(new iTextSharp.text.Chunk("Mã hóa đơn: " + txtMaHDBan.Text + "\n", contentFont));
                infoParagraph.Add(new iTextSharp.text.Chunk("Ngày bán: " + dtpNgayBan.Value.ToString("dd/MM/yyyy") + "\n", contentFont));


                // Thêm bảng thông tin chi tiết hóa đơn
                PdfPTable table = new PdfPTable(dgvHDBanHang.Columns.Count);
                for (int i = 0; i < dgvHDBanHang.Columns.Count; i++)
                {
                    PdfPCell cell = new PdfPCell(new Phrase(dgvHDBanHang.Columns[i].HeaderText));
                    cell.BackgroundColor = new BaseColor(240, 240, 240); // Màu nền của header
                    table.AddCell(cell);
                }
                ...
                for (int i = 0; i < dgvHDBanHang.Rows.Count; i++)
                {
                    ...
                    {
                        table.AddCell(dgvHDBanHang[j, i].Value.ToString());
                    }
                }
                doc.Add(table);

                // Đóng tài liệu và thông báo hoàn tất
                doc.Close();
