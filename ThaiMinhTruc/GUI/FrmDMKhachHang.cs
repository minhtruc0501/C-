...
namespace ThaiMinhTruc.GUI
{
    public partial class FrmDMKhachHang : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            // Thêm dữ liệu vào đầu DataTable và hiển thị lại DataGridView
            DataRow newRow = tblKH.NewRow();
            newRow["MaKhach"] = txtMaKhach.Text.Trim();
            newRow["TenKhach"] = txtTenKhach.Text.Trim();
            newRow["DiaChi"] = txtDiaChi.Text.Trim();
            newRow["DienThoai"] = mtbDienThoai.Text;
            tblKH.Rows.InsertAt(newRow, 0);
